...
int fc0012_exit(void *dev) { (void)dev; return 0; }
...
int fc0012_set_bw(void *dev, int bw) {(void)dev; (void)bw; return 0; }
int _fc0012_set_gain(void *dev, int gain) { return fc0012_set_gain(dev, gain); }
int fc0012_set_gain_mode(void *dev, int manual) { (void)dev; (void)manual; return 0; }

int _fc0013_init(void *dev) { return fc0013_init(dev); }
int fc0013_exit(void *dev) {(void)dev; return 0; }
int fc0013_set_freq(void *dev, uint32_t freq) {
	return fc0013_set_params(dev, freq, 6000000);
}
int fc0013_set_bw(void *dev, int bw) {(void)dev; (void)bw; return 0; }
...
int fc2580_exit(void *dev) { (void)dev; return 0; }
int _fc2580_set_freq(void *dev, uint32_t freq) {
	return fc2580_SetRfFreqHz(dev, freq);
}
int fc2580_set_bw(void *dev, int bw) { (void)bw; return fc2580_SetBandwidthMode(dev, 1); }
int fc2580_set_gain(void *dev, int gain) { (void)dev; (void)gain; return 0; }
int fc2580_set_gain_mode(void *dev, int manual) { (void)dev; (void)manual; return 0; }
